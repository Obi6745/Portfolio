        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">Obi Habibi</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Interactive Media Design student passionate about creating beautiful, functional web experiences that make a difference.
            </p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Obi Habibi. All rights reserved.
            </p>
